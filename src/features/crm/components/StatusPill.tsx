...
function Pill({ label, tono }: { label: string; tono: Tono }) {
  return (
    <span className={`inline-flex items-center px-2 py-0.5 rounded-full border font-mono text-caption uppercase tracking-widest whitespace-nowrap ${TONO_CLASS[tono]}`}>
      {label}
    </span>
  );
}

...
- **Análisis:** get_nutrition_analysis trae lo que Dani ve en Revisión › Adherencia y hábitos (adherencia, pasos, macros, peso, alertas) y get_progress_metrics lo de Revisión › El cuerpo (perímetros con su margen de error, % de grasa y masa magra estimados, readiness); generate_report_draft escribe el borrador de reporte. Mira los dos ANTES de decir si el plan está funcionando: el peso solo no distingue perder grasa de perder músculo, y un perímetro que cambia menos que su error de medición no ha cambiado.

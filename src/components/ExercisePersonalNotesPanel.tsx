  ...
  return (
    <div className="bg-surface border border-white/7 rounded-2xl p-5">
      <h3 className="font-sans font-bold text-base text-white flex items-center gap-2 mb-3">
        ...
        <span className="ml-2 text-[9px] font-mono text-ink-3 normal-case font-sans">(solo la ve este atleta)</span>
      </h3>
      ...
      {loading ? (
        ...
        <div className="space-y-3">
          ...
          {inProgram && (
            <p className="font-mono text-[9px] text-ink-3">Mostrando los ejercicios de sus rutinas asignadas (y los que ya tienen observación).</p>
          )}

    ...
    <div className="space-y-5">
      ...
      {!loading && report && (
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between bg-[#121212] border border-[#2a2a2a] rounded-xl p-4">
            <div>
            ...
            {nutritionConfig?.sharedReportSnapshot ? (
              <button
                ...
                disabled={sharing}
                className="px-3.5 py-2 bg-[#1c1b1b] border border-[#2a2a2a] text-[#c6c9ab] font-mono text-[10px] font-bold uppercase rounded-lg hover:border-red-400/40 hover:text-red-400 transition-all disabled:opacity-50"
              >Dejar de compartir</button>
            ) : (
              <button
                onClick={handleShare}
                disabled={sharing}
                className="px-3.5 py-2 bg-[#e2ff00] text-black font-mono text-[10px] font-bold uppercase rounded-lg hover:bg-[#bad200] transition-all disabled:opacity-50"

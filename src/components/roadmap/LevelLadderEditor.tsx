  ...
  return (
    <div className="space-y-4">
      ...
      {sorted.map(level => {
        ...
        return (
          <div key={level.id} className="bg-surface border border-hairline rounded-surface p-4 space-y-2.5">
            ...
            <div className="space-y-1.5">
              {level.criteria.map(c => (
                <div key={c.id} className="flex flex-wrap items-center gap-1.5 bg-bg border border-hairline rounded-surface p-2">
                  <select
                    value={c.kind}

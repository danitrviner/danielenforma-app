...
export default function NotificationBell({ recipientEmail, onNavigate }: Props) {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {/* Dropdown */}
      {open && (
        <div className="absolute right-0 top-[calc(100%+8px)] w-[min(320px,calc(100vw-1rem))] bg-[#111110] border border-white/7 rounded-2xl shadow-2xl shadow-black/60 z-50 overflow-hidden">
          {/* Header */}

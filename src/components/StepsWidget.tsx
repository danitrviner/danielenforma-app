      ...
      {editing ? (
        <div className="flex items-center gap-2">
          <input
            ...
            placeholder="0"
            autoFocus
            className="flex-1 bg-raised border border-hairline rounded-control px-3 py-1.5 text-white font-mono text-body-s focus:outline-none focus:ring-1 focus:ring-accent"
          />
          <button
            onClick={handleSave}
            disabled={saving}
